namespace VaultASaur3
{
   ...
   public static class Actions
   {
      ...
      public const int CMD_ENABLE_ALL = 105;
      public const int CMD_DISABLE_ALL = 106;
      public const int CMD_ACTIVITY = 107;
      public const int CMD_WWW = 108;
      public const int CMD_URL = 109;
      public const int CMD_EXPORT = 110;
      public const int CMD_SHOW_ALL_SITES = 111;
      public const int CMD_SHOW_ACTIVE_SITES = 112;
