namespace VaultASaur3
{
   ...
   public static class Actions
   {
      ...
      public const int CMD_ACTIVITY = 2;
      public const int CMD_BROWSE = 3;
      public const int CMD_CANCEL = 4;
      public const int CMD_CLEAR = 5;
      public const int CMD_CLIPBOARD_ENCLOSURE = 6;
      public const int CMD_CLIPBOARD_TITLE = 7;
      public const int CMD_CLONE = 8;
      public const int CMD_CLOSE = 9;
      public const int CMD_CONFIG = 10;
      public const int CMD_CONTINUE = 11;
      public const int CMD_COPY_PASSWORD = 12;
      public const int CMD_COPY_URL = 13;
      public const int CMD_COPY_USERNAME = 14;
      public const int CMD_CREATE_FILTER = 15;
      public const int CMD_DEACTIVATE = 16;
      public const int CMD_DELETE = 17;
      public const int CMD_DELETE_ALL = 18;
      public const int CMD_DISABLE_ALL = 19;
      public const int CMD_DOWNLOAD_ALL_NOW = 20;
      public const int CMD_DOWNLOAD_NOW = 21;
      public const int CMD_DOWNLOAD_QUEUE = 22;
      public const int CMD_EDIT = 23;
      public const int CMD_EMAIL = 24;
      public const int CMD_ENABLE_ALL = 25;
      public const int CMD_EXPORT = 26;
      public const int CMD_FEED_RUN_ALL = 27;
      public const int CMD_FEED_RUNNOW = 28;
      public const int CMD_FEEDS = 29;
      public const int CMD_FILE = 30;
      public const int CMD_FILTER = 31;
      public const int CMD_FILTERS = 32;
      public const int CMD_FIND_KEY = 33;
      public const int CMD_FIRST = 34;
      public const int CMD_FTP = 35;
      public const int CMD_GENERATE = 36;
      public const int CMD_GET = 37;
      public const int CMD_HELP = 38;
      public const int CMD_HISTORY = 39;
      public const int CMD_HOME = 40;
      public const int CMD_IMPORT = 41;
      public const int CMD_ISACTIVE = 42;
      public const int CMD_LAST = 43;
      public const int CMD_LIST = 44;
      public const int CMD_LOAD = 45;
      public const int CMD_LOAD_HISTORY = 46;
      public const int CMD_LOADFROMFILE = 47;
      public const int CMD_LOGGING = 48;
      public const int CMD_MAIN_BLOCKS = 49;
      public const int CMD_MAIN_BLOG = 50;
      public const int CMD_MAIN_BROWSE = 51;
      public const int CMD_MAIN_CHECKUPDATES = 52;
      public const int CMD_MAIN_CODES = 53;
      public const int CMD_MAIN_CONTACTUS = 54;
      public const int CMD_MAIN_DATABASE = 55;
      public const int CMD_MAIN_FILES = 56;
      public const int CMD_MAIN_FORUMS = 57;
      public const int CMD_MAIN_FTP = 58;
      public const int CMD_MAIN_HELP = 59;
      public const int CMD_MAIN_HOME = 60;
      public const int CMD_MAIN_LAYOUT = 61;
      public const int CMD_MAIN_NEWS = 62;
      public const int CMD_MAIN_PAGES = 63;
      public const int CMD_MAIN_PUBLISH = 64;
      public const int CMD_MAIN_REGISTER = 65;
      public const int CMD_MOVE = 66;
      public const int CMD_MOVE_DOWN = 67;
      public const int CMD_MOVE_UP = 68;
      public const int CMD_NEW = 69;
      public const int CMD_NEXT = 70;
      public const int CMD_NO = 71;
      public const int CMD_OK = 72;
      public const int CMD_OPEN_IN_BROWSER = 73;
      public const int CMD_PREF = 74;
      public const int CMD_PREF_SAVE = 75;
      public const int CMD_PREV = 76;
      public const int CMD_PRIMARY = 77;
      public const int CMD_PRINT = 78;
      public const int CMD_PRINT_LIST = 79;
      public const int CMD_PRINT_PREVIEW = 80;
      public const int CMD_PRINT_PRINT = 81;
      public const int CMD_PRINT_SETUP = 82;
      public const int CMD_PUBLISH = 83;
      public const int CMD_QUEUE = 84;
      public const int CMD_REGISTER = 85;
      public const int CMD_RENAMER = 86;
      public const int CMD_RENAME = 87;
      public const int CMD_REPEAT = 88;
      public const int CMD_REPORT = 89;
      public const int CMD_RUN_MANUAL = 90;
      public const int CMD_SAVE = 91;
      public const int CMD_SAVETOFILE = 92;
      public const int CMD_SAVE_TO_FEED = 93;
      public const int CMD_SAVE_TO_FEED_ALL = 94;
      public const int CMD_SEARCH = 95;
      public const int CMD_SEARCH_ALL = 96;
      public const int CMD_SECONDARY = 97;
      public const int CMD_SELECT = 98;
      public const int CMD_SELECT_CANCEL = 99;
      public const int CMD_SELECT_OK = 100;
      public const int CMD_SETTINGS = 101;
      public const int CMD_SHOW_ACTIVE_SITES = 102;
      public const int CMD_SHOW_ALL_SITES = 103;
      public const int CMD_SHOW_INACTIVE_SITES = 104;
      public const int CMD_SITES = 105;
      public const int CMD_START_TIMER = 106;
      public const int CMD_STATUS = 107;
      public const int CMD_STOP = 108;
      public const int CMD_STOP_TIMER = 109;
      public const int CMD_TEST_EXPRESSION = 110;
      public const int CMD_TOOLBOX = 111;
      public const int CMD_TORRENT_WEBSITE_SCRAPE = 112;
      ...
      public static actionObject AddNewAction(int inActionType)
      {
         ...
         switch (inActionType)
         {
            ...
            case CMD_FIRST:
               a.Caption = "First";
               a.imageIndex = IMG_NAV_FIRST;
               a.name = "actFirst";
               break;
            case CMD_PREV:
               a.Caption = "Prior";
               a.imageIndex = IMG_NAV_PRIOR;
               a.name = "actPrior";
               break;
            case CMD_NEXT:
               a.Caption = "Next";
            ...
            case CMD_PREF_SAVE:
               ...
               break;
            case CMD_ENABLE_ALL:
               a.Caption = "Enable All";
               a.imageIndex = IMG_GREEN_CHECK;
               a.name = "actEnableAll";
               break;
            case CMD_DISABLE_ALL:
               a.Caption = "Disable All";
               a.imageIndex = IMG_DISABLED;
               a.name = "actDisableAll";
               break;
            case CMD_ACTIVITY:
               a.Caption = "Activity";
               a.imageIndex = IMG_CHECKMARKMARK;
