...
namespace VaultASaur3.Extensions
{
    ...
    public class tToolStrip : ToolStrip
    {
        ...
        #pragma warning disable CS0067 // MenuItemClicked reserved for future use
        ...
        public tToolStrip(Panel targetForm, toolStripSize imgStripSize)
        {
            ...
            // (Height and docking handled above based on the host panel docking.)
            ...
            switch (imgStripSize)
            {
                ...
                case toolStripSize.largeMenu:
                    ImageScalingSize = new Size(50, 50);
        ...
        public void CreateButton(int inButtonCMD, string inHint, Action<int> onClickAction)
        {
            ...
            // Use default ToolStrip spacing (no explicit Margin) so behavior matches
            // the original implementation and system rendering.
